...
class TargetSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.latitude = validated_data.get('enemy_organization', instance.enemy_organization)
        instance.target_goal = validated_data.get('target_goal', instance.target_goal)
        instance.was_target_destroyed = validated_data.get('twas_target_destroyed', instance.was_target_destroyed)
        instance.save()
        return instance
